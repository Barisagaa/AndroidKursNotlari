...
- - 06.03.2018 - Öğlen (Explicit Activity)
- - - [YouTube] (https://youtu.be/GRbU9M_qLmM)
- - 07.03.2018 - Öğlen (StartActivityForResult,Splash Screen)
- - - [YouTube] (https://www.youtube.com/watch?v=5nW5xwFsdoM)
...
- - 07.03.2018 - Akşam (Splash Screen)
- - - [YouTube] (https://youtu.be/RisZQixVqyY)
...
- - 11.03.2018 - Akşam (Shared Preferences, Spinner Adapter with XML)
- - - [YouTube] (https://youtu.be/XWwLXL5FKJM)
- - - [YouTube] (https://youtu.be/eaWVbu7ipQg)
...
# Java/Android Tutorial Websites (Yardımcı Kaynaklar)
